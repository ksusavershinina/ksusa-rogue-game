# содержит инфу про столкновения: хп, броня, атака и тд
# если непись может драться, то у нее есть этот компонент, иначе нет
...
class Fighter(BaseComponent):
    ...
    def hp(self, value: int) -> None:
        # значит, что хп не будет ниже нуля и больше максимума
